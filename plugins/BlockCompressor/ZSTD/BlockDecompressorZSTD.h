...
class BlockDecompressorZSTD : public BlockDecompressor
{
    ...
    public:
        BlockDecompressorZSTD(const std::string& config_path, const std::string& matrix_path, const std::string& ef_path);
        BlockDecompressorZSTD(const ConfigurationLiterate& config, const std::string& matrix_path, const std::string& ef_path);
